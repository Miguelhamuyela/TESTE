            ...
            <div class="inner-page-banner">
                <div class="container">
                    <div class="entry-banner-content breadcrumbs-area">
                        <h1 class="entry-title">Erro 500</h1>
                        <p class="text-white">
                ...
                <div class="row">
                    <div class="col-12 mt-5 pt-5 text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            data-name="Layer 1" width="70%" height="70%" viewBox="0 0 1144 651.26">
                            <defs>
                                <linearGradient id="a2db50a1-d77e-4212-a847-6fb1a49f9674-83" x1="905.83" y1="758.77"
                                    x2="905.83" y2="275.63" gradientUnits="userSpaceOnUse">
                            ...
                            <path
                                ...
                                transform="translate(-28 -124.37)" fill="#1f3a86" opacity="0.1" />
                            <ellipse cx="413" cy="476.76" rx="392" ry="10.5" fill="#1f3a86"
                                opacity="0.1" />
                            <g opacity="0.7">
                            ...
                            <path
                                ...
                                transform="translate(-28 -124.37)" fill="#1f3a86" opacity="0.1" />
                            <ellipse cx="224.19" cy="637.96" rx="40.21" ry="6.8" fill="#1f3a86" />
                            <path
                                ...
                                transform="translate(-28 -124.37)" fill="#1f3a86" />
                            <path
                                ...
                                transform="translate(-28 -124.37)" fill="#3f3d56" />
                            <path
                            ...
                            <path
                                ...
                                transform="translate(-28 -124.37)" fill="url(#a2db50a1-d77e-4212-a847-6fb1a49f9674-83)" />
                            <path
                                ...
                                transform="translate(-28 -124.37)" fill="#fbbebe" />
                            <path
                                d="M870.84,363c6.12-1.65,11.57-5.1,16.91-8.51l18.61-11.85c-5.05-.4-9.41-4-12-8.36s-3.66-9.43-4.54-14.41c-8,3.12-14.93,8.41-21.39,14-2.56,2.21-8,5.55-8.79,9s4.25,6.25,6.2,8.56C866.51,352.2,872.82,362.45,870.84,363Z"
                                transform="translate(-28 -124.37)" opacity="0.1" />
                            <path
                            ...
                            <path d="M630,682.63l19.68,44.5a3.82,3.82,0,0,0,6.93.14L680,679.63Z"
                                transform="translate(-28 -124.37)" fill="#3f3d56" />
                            <path d="M630,682.63l19.68,44.5a3.82,3.82,0,0,0,6.93.14L680,679.63Z"
                                transform="translate(-28 -124.37)" opacity="0.1" />
                            ...
                            <path d="M443,682.63l19.68,44.5a3.82,3.82,0,0,0,6.93.14L493,679.63Z"
                                transform="translate(-28 -124.37)" fill="#3f3d56" />
                            <path d="M443,682.63l19.68,44.5a3.82,3.82,0,0,0,6.93.14L493,679.63Z"
                                transform="translate(-28 -124.37)" opacity="0.1" />
                            <path
                                ...
                                transform="translate(-28 -124.37)" fill="#3f3d56" />
                            <polygon points="368.5 562.76 395.5 545.76 687 543.26 694.5 562.76 368.5 562.76"
                                fill="#1f3a86" />
                            <polygon
                            ...
                            <path d="M415.5,693.13l19.68,44.5a3.82,3.82,0,0,0,6.93.14l23.39-47.64Z"
                                transform="translate(-28 -124.37)" fill="#3f3d56" />
                            <circle cx="643.5" cy="615.76" r="30" fill="#3f3d56" />
                            <circle cx="643.5" cy="615.76" r="19" fill="#65617d" />
                            <path d="M648.5,693.13l19.68,44.5a3.82,3.82,0,0,0,6.93.14l23.39-47.64Z"
                                transform="translate(-28 -124.37)" fill="#3f3d56" />
