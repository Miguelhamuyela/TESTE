        ...
        <nav class="vertnav navbar navbar-light">
            ...
            <div class="w-100  d-flex">
                <a class="navbar-brand mx-auto mt-5 flex-fill text-center" href="{{ route('admin.home') }}">
                    <img rel="icon" src="/site/images/logo/logo-colour.png" style="width:200px; margin:auto" />
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{ route('admin.registration.index') }}">
                            ...
                            <span class="ml-3 item-text">Participantes</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item w-100">
                        <a class="nav-link" href="{{ route('admin.company.index') }}">
                            ...
                            <i class="fe fe-users fe-16"></i>
                            <span class="ml-3 item-text">Empresas</span>
                        </a>
                    </li>
                </ul>
                ...
                <li class="nav-item dropdown">
                    <a href="#speaker" data-toggle="collapse" aria-expanded="false"
                ...
                <li class="nav-item dropdown">
                    <a href="#moderator" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle nav-link">
                        <i class="fe fe-users fe-16"></i>
                        <span class="ml-3 item-text">Moderadores</span>
                    </a>
                    <ul class="collapse list-unstyled pl-4 w-100" id="moderator">

                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('admin.moderators.create') }}">
                                <span class="ml-1 item-text">Cadastrar</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('admin.moderators.index') }}">
                                <span class="ml-1 item-text">Listar</span>
                            </a>
                        </li>
                    </ul>
