    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title">
                Portal do 1º Fórum de Governança da Internet em Angola<br>
            ...
            <div class="card shadow text-dark">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col pr-0">
                            <p class="small text-dark mb-0">Painéis da Agenda</p>
                            <span class="h3 mb-0 text-dark">{{ $count_schedule }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow text-dark">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col pr-0">
                            <p class="small text-dark mb-0">Empresas</p>
                            <span class="h3 mb-0 text-dark">{{ $count_company }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow text-dark">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col pr-0">
                            <p class="small text-dark mb-0">Participantes</p>
                            <span class="h3 mb-0 text-dark">{{ $count_registration }}</span>
                        </div>
                    </div>
                </div>
            </div>
